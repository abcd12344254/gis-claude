...
import { Button, Form, Input, message, Tabs, Steps } from 'antd';
import {
  MailOutlined,
  LockOutlined,
  GlobalOutlined,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          flex: 1,
          background: 'linear-gradient(135deg, #0f1b35 0%, #1a3a5c 40%, #1677ff 100%)',
          display: 'flex',
      ...
      <div style={{ width: 480, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px 56px', background: '#fff' }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 14, color: '#999', margin: 0 }}>
            {activeTab === 'login' ? '登录以继续使用 GIS Claude' : registerStep === 1 ? '注册即可免费体验（50 次/天）' : `验证码已发送至 ${registerEmail}`}
          </p>
        </div>
